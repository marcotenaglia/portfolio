            ...
            <section className='section'>
              ...
              <div id="projects" className="projects">
                ...
                <div className='card-box'>
                  <Projects title="Artist Cathalog" description="WordPress site for the painter Emilio Ghilioni. With home, publications, info and contact pages. Administrable with ACF and integrated with Swiper. Development phase." languages={['WordPress', 'javaScript', 'PHP']} linkWeb='https://dev-emilio-ghilioni.pantheonsite.io/' linkCode='https://github.com/marcotenaglia/emilio-ghilioni' isDarkMode={isDarkMode} />   
