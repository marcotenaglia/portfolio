            ...
            <section className='section'>
              ...
              <div id="projects" className="projects">
                ...
                <div className='card-box'>
                  <Projects title="Artist Cathalog" description="WordPress Website for Artist's Catalog with Home, Publications, Info and Contact pages. Manageable with Advanced Custom Fields and integrated with Swiper. In development phase." languages={['WordPress', 'javaScript', 'PHP', 'Swiper', 'HTML', 'CSS']} linkWeb='https://dev-emilio-ghilioni.pantheonsite.io/' linkCode='https://github.com/marcotenaglia/emilio-ghilioni' isDarkMode={isDarkMode} />   
