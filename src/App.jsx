            ...
            <section className='section'>
              ...
              <div id="projects" className="projects">
                ...
                <div className='card-box'>
                  <Projects title="Artist Cathalog" description="WordPress site for painter with home, publications, info and contact pages. Manageable with ACF and integrated with Swiper. Development phase." languages={['WordPress', 'javaScript', 'PHP', 'Swiper', 'HTML', 'CSS']} linkWeb='https://dev-emilio-ghilioni.pantheonsite.io/' linkCode='https://github.com/marcotenaglia/emilio-ghilioni' isDarkMode={isDarkMode} />   
